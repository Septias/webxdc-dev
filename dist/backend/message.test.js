...
test("distribute to self", () => {
    ...
    const processor = (0, message_1.createProcessor)(onMessage);
...
test("setUpdateListener serial should skip older", () => {
    const processor = (0, message_1.createProcessor)();
    const client0 = processor.createClient("3001");
    const client1 = processor.createClient("3002");
    const client0Heard = [];
    const client1Heard = [];
...
test("clear single client", () => {
    const processor = (0, message_1.createProcessor)();
    const client0 = processor.createClient("3001");
    const client0Cleared = [];
    client0.connect(() => true, 0, () => {
...
test("clear multiple clients", () => {
    ...
    const client1 = processor.createClient("3002");
    const client0Cleared = [];
    const client1Cleared = [];
    client0.connect(() => true, 0, () => {
        client0Cleared.push("cleared");
        return true;
    });
    client1.connect(() => true, 0, () => {
...
test("timestamp", () => __awaiter(void 0, void 0, void 0, function* () {
    const [getMessages, onMessage] = track();
    const processor = (0, message_1.createProcessor)(onMessage);
    const client0 = processor.createClient("3001");
    const client1 = processor.createClient("3002");
